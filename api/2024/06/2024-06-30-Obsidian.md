# Obsidian
---
É um [2024-07-02-Software](api/2024/07/2024-07-02-Software.md) para anotação e organização de ideias baseado em [Grafos](Grafos). As anotações são escritos com [2024-07-08-Markdown](_draft/2024/08/2024-07-08-Markdown.md). Apesar de herdar varias [Sintaxe](Sintaxe) do [2024-07-08-Markdown](_draft/2024/08/2024-07-08-Markdown.md), o Obsidian tem algumas usadas para criar conexões (_links_) entre os documentos para poder criar os grafos.
...
![Cabeçalho](_draft/2024/08/2024-07-08-Markdown.md#Cabeçalho)

![Lista](_draft/2024/08/2024-07-08-Markdown.md#Lista)
### Link
#### Link interno
##### Wikilink
```md
