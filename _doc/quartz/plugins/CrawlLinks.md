...
This plugin parses links and processes them to point to the right places. It is also needed for embedded links (like images). See [[Obsidian compatibility|Obsidian Compatibility]] for more information.
