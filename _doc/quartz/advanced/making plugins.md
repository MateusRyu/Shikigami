...
- `BuildCtx` is defined in `quartz/ctx.ts`. It consists of
  - `argv`: The command line arguments passed to the Quartz [[build|Building your Quartz]] command
  - `cfg`: The full Quartz [[configuration|Configuration]]
  - `allSlugs`: a list of all the valid content slugs (see [[paths|Paths in Quartz]] for more information on what a `ServerSlug` is)
...
- Your component should use `getQuartzComponents` to declare a list of `QuartzComponents` that it uses to construct the page. See the page on [[creating components|Creating your own Quartz components]] for more information.
